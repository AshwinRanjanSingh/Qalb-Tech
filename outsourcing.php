...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">BPO Services</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">BPO Services</a>
        </div>
    </div>
</div>

<div id="bpo-services" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Focus on Core Activities, Maximize Efficiency</h2>
            <p class="overview-text">Our Business Process Outsourcing (BPO) services allow businesses to focus on their core activities while we handle support, operations, and back-office tasks. With 24/7 multilingual support, advanced tools, and scalable solutions, we ensure cost savings and better efficiency.</p>
            <p class="overview-text">We provide essential support services that are scalable to meet peak demand and help you achieve measurable cost reduction.</p>
        </div>
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Voice, email, and chat-based support.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Troubleshooting IT and software issues.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Payroll, bookkeeping, and reporting.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Recruitment, onboarding, and employee management.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Accurate and efficient data handling.</p>
                </div>
            </div>
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Save up to 60% of operational expenses.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    <h3>Scalability</h3>
                    <p>Flexible workforce for peak and low demand.</p>
                </div>
            </div>
        ...
        <div class="deliver-grid sub-types-grid">
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Admin, HR, and finance support.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">🛠</div>
                <div class="card-text">
                    <h3>Tech Support Outsourcing</h3>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                <div class="icon-placeholder">🧠</div>
                <div class="card-text">
                    <h3>Knowledge Process Outsourcing</h3>
                    <p>Analytics, research, and reporting.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">BPO Services by Industry Focus</h2>
        </div>

        <div id="finance" class="industry-section-card content-container scroll-animate" data-delay="200">
            <h3>Banking & Finance 🏦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Loan processing outsourcing.</li>
                        <li>Credit card back-office services.</li>
                        <li>KYC & compliance support.</li>
                        <li>Fraud monitoring desk.</li>
                ...
                <!-- <div>
                    ...
                    <ul>
                        <li>Genpact, Infosys BPO.</li>
                        <li>TCS BaNCS BPO  36], Wipro BPO.</li>
                        <li>Focus on data security.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="insurance" class="industry-section-card content-container scroll-animate" data-delay="400">
            ...
            <div class="card-content-flex">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Patient support outsourcing.</li>
                        <li>Pharmacy call centers.</li>
                ...
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Cognizant Healthcare BPO.</li>
                        <li>Wipro Health BPO , Infosys Insurance BPO.</li>
        ...
        <div id="retail" class="industry-section-card content-container scroll-animate" data-delay="600">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Customer order support.</li>
                        <li>Refund & returns desk.</li>
                        <li>Omnichannel shopping care.</li>
                        <li>Promotional campaign helplines.</li>
                        <li>Back-office retail desk.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Teleperformance, Genpact.</li>
                        <li>Concentrix Retail BPO , Wipro BPO.</li>
                        <li>Focus on CX & scale.</li>
                    </ul>
                </div> -->
            </div>
        </div>
        ...
        <div id="telecom" class="industry-section-card content-container scroll-animate" data-delay="800">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Customer care outsourcing.</li>
                        <li>Bill payment desk.</li>
                        <li>Technical troubleshooting.</li>
                        <li>New service request desk.</li>
                        <li>Utility connection support.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Concentrix Telecom BPO.</li>
                        <li>Teleperformance Utilities , Wipro Telecom BPO.</li>
        ...
        <div id="it" class="industry-section-card content-container scroll-animate" data-delay="1000">
            <h3>IT & SaaS ☁</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Tech support helpdesk.</li>
                        <li>Customer success desk.</li>
                        <li>Software troubleshooting desk.</li>
                        <li>Cloud support outsourcing.</li>
                        <li>24/7 SaaS support.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Infosys IT BPO.</li>
                        <li>TCS SaaS BPO, Wipro Tech BPO.</li>
                        <li>Focus on reliability & uptime.</li>
                    </ul>
                </div> -->
            </div>
        </div>
