...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">IVR Solutions</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">IVR Solutions</a>
        </div>
    </div>
</div>

<div id="ivr-solutions" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Automate Calls, Enhance Efficiency</h2>
            <p class="overview-text">Our IVR (Interactive Voice Response) solutions automate customer calls, making your business more efficient.</p>
            <p class="overview-text">From multilingual menus to CRM integrations, IVR ensures faster query handling and improved customer experience.</p>
        </div>
    ...
    <div class="services-included-section content-container">
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    <h3>Custom IVR Design</h3>
                    <p>Personalized voice menus.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Localized experiences for global users.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Automatic data flow for better service.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Customers can resolve queries without agents.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Insights into call performance.</p>
                </div>
            </div>
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Faster resolution through automation.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Flexible to match growing needs.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>Data Insights</h3>
                    <p>Improve service using analytics.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sub-types-section content-container">
        ...
        <div class="deliver-grid sub-types-grid">
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">🗣</div>
                <div class="card-text">
                    <h3>Multi-Language IVR</h3>
                    <p>Support for diverse audiences.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>Cloud IVR</h3>
                    <p>Remote and scalable systems.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">IVR Solutions by Industry Focus</h2>
        </div>
        ...
        <div id="bank" class="industry-section-card content-container scroll-animate" data-delay="200">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases  112]</h4>
                    <ul>
                        <li>Automated account balance inquiry.</li>
                        <li>Loan application status via IVR.</li>
                        <li>Transaction alerts & fraud reporting.</li>
                        <li>Credit card activation IVR.</li>
                        <li>Multi-language IVR banking support.</li>
                    </ul>
                </div>
                <!-- <div>
                    ...
                    <ul>
                        ...
                        <li>Cisco IVR.</li>
                        <li>Twilio.</li>
                        <li>Focus on customer self-service.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="cable" class="industry-section-card content-container scroll-animate" data-delay="400">
            <h3>Telecom & Cable ☎</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Prepaid recharge IVR.</li>
                        <li>Plan upgrade IVR.</li>
                        <li>Service outage info via IVR.</li>
                        <li>Bill payment IVR systems.</li>
                        <li>Troubleshooting via IVR bots.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        ...
                        <li>Avaya Telecom.</li>
                        <li>Cisco IVR.</li>
                        <li>Focus on large scale service.</li>
                    </ul>
                </div> -->
            </div>
        </div>
        ...
        <div id="health" class="industry-section-card content-container scroll-animate" data-delay="600">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Appointment scheduling IVR.</li>
                        <li>Lab result notifications.</li>
                        <li>Follow-up reminders.</li>
                        <li>Pharmacy refills & updates.</li>
                        <li>Doctor availability IVR.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys, Cisco.</li>
                        <li>Avaya Health IVR.</li>
                        <li>Twilio Health.</li>
                        <li>Focus on patient ease.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="logistic" class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>E-commerce & Logistics 📦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Order status IVR.</li>
                        <li>Return/exchange inquiry.</li>
                        <li>Delivery tracking via IVR.</li>
                        <li>Warehouse inquiry hotlines.</li>
                        <li>Shipment confirmation calls.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Twilio, Five9.</li>
                        <li>Avaya Commerce.</li>
                        <li>Cisco Logistics IVR.</li>
        ...
        <div id="insuranc" class="industry-section-card content-container scroll-animate" data-delay="1000">
            <h3>Insurance 🛡 </h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Claims status IVR.</li>
                        <li>Policy info inquiry.</li>
                        <li>Premium payment reminders.</li>
                        <li>Agent connect hotlines.</li>
                        <li>Emergency assistance IVR.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys, Avaya.</li>
                        <li>Cisco IVR.</li>
                        <li>Five9 Insurance.</li>
                        <li>Focus on cost saving.</li>
                    </ul>
                </div> -->
            </div>
        </div>
