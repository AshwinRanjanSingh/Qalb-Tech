...
?>
        ...
        <div class="container-fluid bg-primary py-5 bg-header2" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">Contact Us</h1>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">info@qalbtech.com</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="form.php" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" name="service" class="form-control border-0 bg-light px-4" placeholder="Subject" style="height: 55px;">
                            </div>
                            <div class="col-12">
