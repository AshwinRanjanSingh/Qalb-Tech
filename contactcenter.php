...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">Unified Contact Center</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">Unified Contact Center</a>
        </div>
    </div>
</div>

<div id="unified-contact-center" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Seamless Customer Experience Across All Channels</h2>
            <p class="overview-text">Our unified contact center solutions integrate all communication channels—voice, email, chat, and social—into one platform. With intelligent routing and AI-powered tools, you can deliver faster, more personalized customer support and a truly omnichannel experience.</p>
            <p class="overview-text">We ensure that every customer interaction, regardless of the channel, is consistent, efficient, and context-aware, leading to higher satisfaction and agent productivity.</p>
        </div>
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Centralized handling of calls, chats, and emails.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Match customers with the best agent instantly.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Tools to optimize agent schedules and performance.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Performance insights to improve KPIs.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Automation to reduce agent workload.</p>
                </div>
            </div>
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Consistent customer service across all channels.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Reduced workload through automation.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    <h3>Scalability</h3>
                    <p>Contact centers that grow with your needs.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>Cost Savings</h3>
                    <p>Streamlined operations reduce expenses.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sub-types-section content-container">
        <h2 class="section-title">Explore Contact Center Sub-Types</h2>
        <div class="deliver-grid sub-types-grid">
            <div class="deliver-card sub-type-card scroll-animate" data-delay="100">
                <div class="icon-placeholder">☁</div>
                <div class="card-text">
                    <h3>Cloud Contact Center</h3>
                    <p>Remote-friendly, scalable and flexible systems.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                <div class="icon-placeholder">📱</div>
                <div class="card-text">
                    <h3>Omnichannel Center</h3>
                    <p>Full integration of multi-channel support.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">🤖</div>
                <div class="card-text">
                    <h3>AI-Enabled Center</h3>
                    <p>Smart bots, virtual agents, and advanced automation.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                <div class="icon-placeholder">🔄</div>
                <div class="card-text">
                    <h3>Hybrid Contact Center</h3>
                    <p>Mix of cloud and in-house systems.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">Unified Contact Center by Industry Focus</h2>
        </div>

        <div id="banking" class="industry-section-card content-container scroll-animate" data-delay="200">
            <h3>Banking & Insurance 🏦🛡</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Unified banking helplines & Claims support.</li>
                        <li>Loan application support & Omnichannel engagement.</li>
                        <li>Fraud & risk reporting.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys, Five9, NICE inContact.</li>
                        <li>Cisco Contact Center.</li>
                        <li>Focus on omnichannel CX.</li>
                    </ul> -->
                </div>
            </div>
        </div>

        <div id="e-commerce" class="industry-section-card content-container scroll-animate" data-delay="400">
            <h3>E-commerce & Retail 🛍</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Customer complaints desk & Refund management.</li>
                        <li>Omnichannel shopping support (chat, social, call).</li>
                        <li>Product promotion queries.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>RingCentral, 8x8, Genesys.</li>
                        <li>Cisco Retail.</li>
                        <li>Focus on seamless CX.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="ISP" class="industry-section-card content-container scroll-animate" data-delay="600">
            <h3>Telecom & ISP ☎</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Troubleshooting tickets & Plan upgrades.</li>
                        <li>Billing support desk & New connection onboarding.</li>
                        <li>Network outage updates.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Avaya Contact Center, Cisco Contact Solutions.</li>
                        <li>NICE inContact.</li>
                        <li>Focus on fast resolution.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="hospital" class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>Healthcare & Hospitals 🏥</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Doctor appointment booking desk & Insurance claim assistance.</li>
                        <li>Medical record helpline & Pharmacy order desk.</li>
                ...
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys Health Contact, Cisco Health Desk.</li>
                        <li>RingCentral Health.</li>
        ...
        <div id="travel" class="industry-section-card content-container scroll-animate" data-delay="1000">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Flight & hotel booking helpline & Rescheduling desk.</li>
                        <li>Customer loyalty program desk & Trip cancellation support.</li>
                        <li>24/7 global customer assistance.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Five9, Genesys, Avaya.</li>
                        <li>Cisco Solutions.</li>
                        <li>Focus on customer assistance (Inferred from content).</li>
                    </ul>
                </div> -->
            </div>
        </div>
