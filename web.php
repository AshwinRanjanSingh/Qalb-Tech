...
.has-subdropdown:hover > .subdropdown {
    ...
    <style>
        ...
        .bg-header3 {
            background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(../img/privacy.png) center center no-repeat;
            background-size: cover;
            height: 500px;
        }

        .bg-header4 {
            background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(../img/terms.png) center center no-repeat;
            background-size: cover;
            height: 500px;
        }
...
<body>
    ...
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">Web Development</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">Web Development</a>
        </div>
    </div>
</div>

<div id="web-development" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Building a Strong Digital Identity</h2>
            <p class="overview-text">Our web development services empower businesses to build a strong digital identity. We design and develop responsive, SEO-friendly, and user-focused websites that ensure seamless navigation and high performance. Whether it’s an e-commerce store, corporate website, or a custom web application, our team ensures every solution is scalable, secure, and tailored to your business goals.</p>
            <p class="overview-text">By combining modern technologies with creative design, we deliver websites that enhance engagement, drive measurable results, and provide a foundation for long-term growth.</p>
        </div>
    ...
    <div class="services-included-section content-container">
        <h2 class="section-title">Our Integrated Web Development Services</h2>
        <div class="service-grid">
            <div class="service-card scroll-animate" data-delay="100">
                <div class="icon-placeholder">🎨</div>
                <div class="card-text">
                    <h3>Front-End Development</h3>
                    <p>Interactive, responsive, and user-friendly interfaces built using modern frameworks.</p>
                </div>
            </div>
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Secure, high-performance server-side solutions ensuring reliable operations.</p>
                </div>
            </div>
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Scalable online stores with advanced features and secure payment integration.</p>
                </div>
            </div>
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Flexible content management systems that simplify updates and customization.</p>
                </div>
            </div>
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Ongoing monitoring, updates, and security checks for long-term reliability.</p>
                </div>
            </div>
            <div class="service-card scroll-animate" data-delay="600">
                ...
                <div class="card-text">
                    ...
                    <p>Seamless integration of third-party services to expand functionality.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Tailored designs aligned with your brand identity and business goals.</p>
                </div>
            </div>
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Optimized for higher search rankings and improved discoverability.</p>
                </div>
            </div>
            <div class="deliver-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">📱</div>
                <div class="card-text">
                    <h3>Mobile-first Designs</h3>
                    <p>Fully responsive websites accessible across all devices.</p>
                </div>
            </div>
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Platforms that grow seamlessly with your business needs.</p>
                </div>
            </div>
            <div class="deliver-card scroll-animate" data-delay="500">
                <div class="icon-placeholder">🔒</div>
                <div class="card-text">
                    <h3>Security-focused Builds</h3>
                    <p>Enhanced protection against cyber threats and vulnerabilities.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="deliver-grid sub-types-grid">
            <div class="deliver-card sub-type-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Professional websites showcasing brand and services.</p>
                </div>
            </div>
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Secure and feature-rich online shopping solutions.</p>
                </div>
            </div>
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Tailored apps designed to fit unique workflows.</p>
                </div>
            </div>
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>CMS Websites</h3>
                    <p>Flexible platforms for content-heavy businesses.</p>
                </div>
            </div>
            <div class="deliver-card sub-type-card scroll-animate" data-delay="500">
                <div class="icon-placeholder">📰</div>
                <div class="card-text">
                    <h3>Portfolio & Blogs</h3>
                    <p>Personal or professional platforms to highlight work and ideas.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">Web Development by Industry Focus</h2>
        </div>
        ...
        <div id="ecommerce" class="industry-section-card content-container scroll-animate" data-delay="200">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Online store development & marketplaces.</li>
                        <li>Integration with secure payment gateways.</li>
                        <li>Inventory & order management portals.</li>
                        <li>Mobile-first shopping apps.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Providers: Shopify, Magento, WooCommerce, BigCommerce, Wix, Accenture, Cognizant, Local Web Agencies.</li>
                        <li>Focus on scalability & UX design.</li>
                    </ul>
                </div> -->
            </div>
        </div>
        ...
        <div id="tech" class="industry-section-card content-container scroll-animate" data-delay="400">
            <h3>Tech Startups & SaaS ☁</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Custom dashboards & SaaS apps.</li>
                        <li>API & third-party integrations.</li>
                        <li>Agile MVP development.</li>
                ...
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Providers: Toptal, Infosys, Freelancers, AWS/Azure SaaS Enablement Partners.</li>
                        <li>Focus on rapid deployment & innovation.</li>
                    </ul>
                </div> -->
            </div>
        </div>
        ...
        <div id="healthcare" class="industry-section-card content-container scroll-animate" data-delay="600">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Patient portals & telemedicine apps.</li>
                        <li>Appointment scheduling & billing systems.</li>
                        <li>Integration with EHR/EMR.</li>
                        <li>HIPAA-compliant cloud platforms.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Providers: Infosys, Cognizant, Microsoft Azure Healthcare, Oracle Health, Cerner.</li>
                        <li>Focus on privacy & compliance.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="media" class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>Media & Entertainment 🎬</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>OTT streaming portals.</li>
                        <li>Subscription & ad-based platforms.</li>
                        <li>Content delivery & management.</li>
                ...
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Providers: Accenture, Disney Tech, Netflix APIs, Warner Media Tech, Local Dev Firms.</li>
                        <li>Focus on content delivery speed.</li>
                    </ul>
                </div> -->
            </div>
        </div>
            ...
            <div class="card-content-flex">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Virtual classrooms & live classes.</li>
                        <li>Student management & assessments.</li>
                        <li>Gamified learning portals.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Providers: Blackboard, Coursera Tech, Moodle, Pearson Digital, Local EdTech Agencies.</li>
                        <li>Focus on student engagement & scalability.</li>
                    </ul>
                </div> -->
            </div>
        </div>
