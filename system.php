    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">System Administration</h1>
                <a href="" class="h5 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h5 text-white">System Administration</a>
            </div>
        </div>
    </div>
    </div>
 <div id="system-administration" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Uninterrupted IT Operations and Reliability</h2>
            <p class="overview-text">Our system administration services ensure uninterrupted IT operations and infrastructure reliability. We handle everything from server installation and configuration to proactive monitoring and cloud management.</p>
            <p class="overview-text">With a focus on performance, security, and scalability, we ensure your systems remain optimized, secure, and compliant while enabling your team to focus on business growth.</p>
        </div>
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Installation and optimization of dedicated and virtual servers.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Seamless connectivity with reliable monitoring and troubleshooting.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Secure, automated backups and disaster recovery planning.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Firewalls, compliance tools, and security audits.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Virtualization and hybrid cloud environment management.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="600">
                ...
                <div class="card-text">
                    ...
                    <p>Regular tuning and health checks for sustained performance.</p>
                </div>
            </div>
    ...
    <div class="deliver-section content-container">
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                <div class="icon-placeholder">✅</div>
                <div class="card-text">
                    <h3>Stable IT Infrastructure</h3>
                    <p>Reliable systems that minimize downtime.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Proactive checks and alerts to prevent failures.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Seamless integration of on-premise and cloud systems.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Strong safeguards for data and applications.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Optimized resource use reducing IT overhead.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="deliver-grid sub-types-grid">
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>High-speed connectivity and troubleshooting.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Safeguarding your digital assets.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Flexible platforms for modern business.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">System Administration by Industry Focus</h2>
        </div>

        <div id="it" class="industry-section-card content-container scroll-animate" data-delay="200">
            ...
            <div class="card-content-flex">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Data security monitoring.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>IBM, HCL, Infosys, Rackspace.</li>
                        <li>AWS & Azure Managed Services , TCS.</li>
                        <li>Focus on uptime & scalability.</li>
                    </ul>
                </div> -->
            </div>
        </div>
        ...
        <div id="healthcare" class="industry-section-card content-container scroll-animate" data-delay="400">
            ...
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>HIPAA-compliant IT systems  & Secure hospital networks.</li>
                        <li>Pharma research data management.</li>
                        <li>Patient data protection.</li>
                        <li>24/7 monitoring  & Disaster recovery.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Wipro, IBM, Infosys , Oracle Health IT , Cerner.</li>
                        <li>Focus on compliance & privacy.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="financial" class="industry-section-card content-container scroll-animate" data-delay="600">
            <h3>Financial Institutions 🏦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Core banking IT operations  & Secure fintech servers.</li>
                        <li>Fraud monitoring systems  & Trading platforms uptime.</li>
                        <li>KYC data handling  & Compliance audit systems.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Rackspace, IBM Cloud , Infosys Finacle , TCS BaNCS.</li>
                        <li>Focus on financial security.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="ecommerce" class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>E-commerce & Logistics 📦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Traffic load balancing  & Secure payment servers.</li>
                        <li>Inventory management IT systems.</li>
                        <li>Supply chain cloud infrastructure  & Logistics dashboards.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Managed IT Providers , AWS Cloud , Infosys Logistics.</li>
                        <li>Focus on high availability.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="goverment" class="industry-section-card content-container scroll-animate" data-delay="1000">
            <h3>Government & Defense 🛡</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Secure data centers  & Defense communication IT systems.</li>
                        <li>Military-grade cybersecurity.</li>
                        <li>Gov e-governance portals  & Confidential data hosting.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>HCL, Infosys, IBM , Northrop Grumman IT , Local Defense IT Firms.</li>
                        <li>Focus on national security.</li>
                    </ul>
                </div> -->
            </div>
        </div>
