...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">Toll-Free Number Solutions</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">Toll-Free Number Solutions</a>
        </div>
    </div>
</div>

<div id="toll-free-solutions" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Easy Customer Access & Professionalism</h2>
            <p class="overview-text">Our toll-free number solutions make it easy for customers to reach you, improving accessibility and professionalism.</p>
            <p class="overview-text">With features like call routing and analytics, your customer service becomes faster and more effective, ensuring minimal delays and providing data-driven insights.</p>
        </div>
    ...
    <div class="services-included-section content-container">
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    <h3>1800 Number Setup</h3>
                    <p>Widely recognized and trusted toll-free numbers .</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Customized numbers (like 1-800-FLOWERS) for better brand recall.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    ...
                    <p>Direct customers to the right department or agent instantly.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Track call flow, volume, and performance for data-driven decisions.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    ...
                    <p>Receive calls on mobile, VoIP, or desktops for maximum flexibility.</p>
                </div>
            </div>
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    ...
                    <p>Enhance brand trust with easy toll-free accessibility.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Efficient call routing ensures minimal delays for customers.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    <h3>Global Reach</h3>
                    <p>Offer international toll-free numbers for worldwide accessibility .</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Utilize call data and analytics for informed, data-driven decisions.</p>
                </div>
            </div>
    ...
    <div class="design-points full-width-process">
        ...
        <div class="points-container content-container">
            <div class="point-card scroll-animate" data-delay="200">
                ...
                <h3>Consultation</h3>
                <p>Helping you choose the optimal number type and service level.</p>
            </div>
            <div class="point-card scroll-animate" data-delay="400">
                <span class="point-number">02</span>
                <h3>Activation & Integration</h3>
                <p>Quick setup, activation, and integration with your existing systems.</p>
            </div>
            <div class="point-card scroll-animate" data-delay="600">
                <span class="point-number">03</span>
                <h3>CRM Integration</h3>
                <p>Seamless customer data flow and context for agents via CRM sync.</p>
            </div>
            <div class="point-card scroll-animate" data-delay="800">
                <span class="point-number">04</span>
                <h3>Ongoing Support</h3>
                <p>Continuous upgrades, performance monitoring, and dedicated support.</p>
            </div>
        </div>
    </div>

    <div class="sub-types-section content-container">
        <h2 class="section-title">Explore Toll-Free Sub-Types</h2>
        <div class="deliver-grid sub-types-grid">
            <div class="deliver-card sub-type-card scroll-animate" data-delay="100">
                <div class="icon-placeholder">☎</div>
                <div class="card-text">
                    <h3>1800 Numbers</h3>
                    <p>Standard, widely trusted toll-free access for domestic customers.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    <h3>Vanity Numbers</h3>
                    <p>Memorable, customized digits for strong marketing campaigns.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">✈</div>
                <div class="card-text">
                    <h3>International Toll-Free</h3>
                    <p>Global communication options for reaching customers worldwide.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Automated transfers based on customer input or location.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">Toll-Free Solutions by Industry Focus</h2>
        </div>

        <div id="Bank" class="industry-section-card content-container scroll-animate" data-delay="200">
            <h3>Banking & Financial Services 🏦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Toll-free helpline for account support.</li>
                        <li>Loan inquiry & credit card support.</li>
                        <li>Fraud reporting lines.</li>
                ...
                <!-- <div>
                    ...
                    <ul>
                        <li>AT&T;, Verizon, RingCentral.</li>
                        <li>Grasshopper.</li>
                        <li>Focus on reliable access.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="retail" class="industry-section-card content-container scroll-animate" data-delay="400">
            <h3>Retail & E-commerce 🛍</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Order placement & inquiry lines.</li>
                        <li>Toll-free returns & refund support.</li>
                        <li>Promotional campaign hotlines.</li>
                ...
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>8x8, Vonage, RingCentral.</li>
                        <li>AT&T; Toll-free.</li>
                        <li>Focus on customer engagement.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="health" class="industry-section-card content-container scroll-animate" data-delay="600">
            <h3>Healthcare 🏥</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Patient appointment booking lines.</li>
                        <li>Insurance claim hotlines.</li>
                        <li>Emergency health lines.</li>
                        <li>Medication refill inquiries.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>AT&T; Healthcare, Cisco Health.</li>
                        <li>RingCentral.</li>
                        <li>Focus on HIPAA safety.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="telecom" class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>Utilities & Telecom ⚡</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Bill payment helplines.</li>
                        <li>Service outage reporting lines.</li>
                        <li>Technical troubleshooting lines.</li>
                        <li>24/7 service desks.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Verizon, AT&T;, RingCentral .</li>
                        <li>8x8.</li>
                        <li>Focus on uptime.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div id="travel" class="industry-section-card content-container scroll-animate" data-delay="1000">
            <h3>Travel & Logistics ✈</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Toll-free flight booking support.</li>
                        <li>Baggage claim inquiries.</li>
                        <li>Travel cancellation support.</li>
                        <li>Shipment tracking helplines.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Vonage Travel, RingCentral.</li>
                        <li>AT&T; Toll-free.</li>
