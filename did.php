...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-4 text-white animated zoomIn" style="margin-top: 90px;">DID Solutions</h1>
            <a href="" class="h5 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">DID Solutions</a>
        </div>
    </div>
</div>

<div id="did-solutions" class="main-content active full-width-layout">
    <div class="overview-section content-container section-flex">
        <div class="" data-delay="100">
            <h2 class="section-title">Overview: Direct Inward Dialing for Efficient Routing</h2>
            <p class="overview-text">DID (Direct Inward Dialing) Solutions provide unique virtual phone numbers that allow external callers to directly reach specific employees, departments, or locations without passing through a central reception.</p>
            <p class="overview-text">This technology enables organizations to manage inbound calls efficiently, build local presence in multiple regions, and enhance the caller experience with faster connection and better tracking.</p>
        </div>
    ...
    <div class="services-included-section content-container">
        ...
        <div class="service-grid">
            ...
            <div class="service-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    <h3>Global DID Provisioning</h3>
                    <p>Local and international DID provisioning for multi-region presence.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Cloud-based number management with instant activation.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">🔄</div>
                <div class="card-text">
                    <h3>Advanced Call Routing</h3>
                    <p>Advanced call routing, forwarding, and overflow management.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    ...
                    <p>Integration with PBX, VoIP, and contact center platforms.</p>
                </div>
            </div>
            ...
            <div class="service-card scroll-animate" data-delay="500">
                ...
                <div class="card-text">
                    <h3>DID Analytics</h3>
                    <p>DID analytics for call tracking and performance reporting.</p>
                </div>
            </div>
    ...
    <div class="deliver-section content-container">
        ...
        <div class="deliver-grid">
            <div class="deliver-card scroll-animate" data-delay="100">
                ...
                <div class="card-text">
                    <h3>Global Reach</h3>
                    <p>Establish virtual offices worldwide with local inbound numbers.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="200">
                ...
                <div class="card-text">
                    ...
                    <p>Replace multiple physical lines with virtual DID numbers.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="300">
                ...
                <div class="card-text">
                    <h3>Smart Routing</h3>
                    <p>Route calls directly to departments or teams, reducing delays.</p>
                </div>
            </div>
            ...
            <div class="deliver-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>Scalability</h3>
                    <p>Instantly add or deactivate numbers as business needs change.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sub-types-section content-container">
        ...
        <div class="deliver-grid sub-types-grid">
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="200">
                <div class="icon-placeholder">✈</div>
                <div class="card-text">
                    <h3>International DIDs</h3>
                    <p>Enable global inbound access without physical offices.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="300">
                <div class="icon-placeholder">🆓</div>
                <div class="card-text">
                    <h3>Toll-Free DIDs</h3>
                    <p>Free inbound numbers for customer convenience.</p>
                </div>
            </div>
            ...
            <div class="deliver-card sub-type-card scroll-animate" data-delay="400">
                ...
                <div class="card-text">
                    <h3>Mobile DIDs</h3>
                    <p>Direct routing to mobile or softphone endpoints.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="industry-background">
        <div class="content-container">
            <h2 class="section-title scroll-animate" data-delay="100">DID Solutions by Industry Focus</h2>
        </div>

        <div class="industry-section-card content-container scroll-animate" data-delay="200">
            <h3>Banking & Financial Services 🏦</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Dedicated DIDs for regional branches and relationship managers.</li>
                        <li>Customer verification lines for secure banking communication.</li>
                        <li>Direct inbound hotlines for loan, credit, and insurance departments.</li>
                        <li>Local DIDs improving customer accessibility in remote markets.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Cisco Financial Connect, Twilio Banking DID, Avaya Secure Dial.</li>
                        <li>Focus on *Compliance, reliability, customer accessibility*.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div class="industry-section-card content-container scroll-animate" data-delay="400">
            <h3>Healthcare & Telemedicine 🏥</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Assign DIDs to departments for direct patient communication.</li>
                        <li>Virtual numbers for teleconsultations and appointment scheduling.</li>
                        <li>Centralized hospital communication via DID-based routing.</li>
                        <li>HIPAA-compliant DID systems ensuring data security.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys Health DID, Twilio Medical Voice, Nextiva Healthcare Connect.</li>
                        <li>Focus on *Patient experience, compliance, reliability*.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div class="industry-section-card content-container scroll-animate" data-delay="600">
            <h3>Education & E-Learning 📚</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Dedicated DIDs for admissions, student support, and faculty offices.</li>
                        <li>Regional DIDs for online institutions managing country-wise helplines.</li>
                        <li>Virtual classroom hotlines for student-faculty communication.</li>
                        <li>Call analytics for admissions and counseling efficiency.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Vonage Education Connect, Twilio Campus Voice, Nextiva EduCall.</li>
                        <li>Focus on *Accessibility, engagement, performance monitoring*.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div class="industry-section-card content-container scroll-animate" data-delay="800">
            <h3>Real Estate & Property Management 🏠</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Unique DIDs for each agent or property listing for direct inquiries.</li>
                        <li>Dynamic number allocation for marketing campaigns.</li>
                        <li>Local DIDs to build regional trust with buyers and tenants.</li>
                        <li>Call tracking for lead analytics and agent performance.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>RingCentral Realty DID, Twilio Property Line, Five9 Real Estate Connect.</li>
                        <li>Focus on *Lead tracking, local presence, agent efficiency*.</li>
                    </ul>
                </div> -->
            </div>
        </div>

        <div class="industry-section-card content-container scroll-animate" data-delay="1000">
            <h3>Travel & Hospitality ✈</h3>
            <div class="card-content-flex">
                <div>
                    <h4>Use Cases</h4>
                    <ul>
                        <li>Dedicated inbound numbers for bookings, cancellations, and feedback.</li>
                        <li>Regional DIDs for travel agencies and franchise hotels.</li>
                        <li>Tracking marketing ROI through unique campaign-based numbers.</li>
                        <li>Automated rerouting during high call volume seasons.</li>
                    </ul>
                </div>
                <!-- <div>
                    <h4>Providers & Focus</h4>
                    <ul>
                        <li>Genesys Travel Voice, Twilio Hospitality Line, Nextiva Tourism Connect.</li>
                        <li>Focus on *Customer satisfaction, scalability, automation*.</li>
                    </ul>
                </div> -->
            </div>
        </div>
