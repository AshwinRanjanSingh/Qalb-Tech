                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        ...
                        <form action="sign.php" method="POST">
                            <div class="input-group">
                                <input type="email" class="form-control border-white p-3" name="email" placeholder="Your Email">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">info@qalbtech.com</p>
                            </div>
                            <div class="d-flex mb-2">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="privacypolicy.php"><i class="bi bi-arrow-right text-primary me-2"></i>Privacy Policy</a>
                                <!-- <a class="text-light mb-2 d-none" href="#"><i class="bi bi-arrow-right text-primary me-2 d-none"></i>Meet The Team</a>
                                <a class="text-light mb-2 d-none" href="#"><i class="bi bi-arrow-right text-primary me-2 d-none"></i>Latest Blog</a> -->
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">QALB TECH</a>. All Rights Reserved. 
